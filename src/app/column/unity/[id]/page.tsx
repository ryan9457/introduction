...
export default async function SpriteAutoSlicer({ params }: Props) {
  ...
  return (
    <div className="min-h-screen bg-neutral-100 dark:bg-neutral-900 text-gray-800 dark:text-gray-100 p-8">
      <Toolkit
        id={id}
        ...
        `}
        topic={`自動化裁圖工具`}
        features={['導入資源即自動裁切', '支援單圖', '支援圖集(需有參照描述檔 "json")']}
        steps={[
          {
